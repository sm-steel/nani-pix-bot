...
def test_stop_confirm_keyboard_offers_reveal_when_there_is_something_to_reveal() -> None:
    markup = stop_confirm_keyboard(lang="en", can_reveal=True)
...
def test_stop_confirm_keyboard_labels_are_translated() -> None:
    markup_en = stop_confirm_keyboard(lang="en", can_reveal=True)
    markup_ru = stop_confirm_keyboard(lang="ru", can_reveal=True)
