...
class Game(Base):
    ...
    title_romaji: Mapped[str | None] = mapped_column(default=None)
    title_english: Mapped[str | None] = mapped_column(default=None)
    title_native: Mapped[str | None] = mapped_column(default=None)
    ...
    original_file_id: Mapped[str | None] = mapped_column(default=None)
